...
assert set(mappings) == {{"DGemmaLoader", "DGemmaSampler", "DGemmaTrace", "DGemmaTallyAudit", "DGemmaRunLogWriter", "DGemmaEncode", "DGemmaDenoise", "DGemmaTokenTrace"}}, sorted(mappings)
